@/home/student/Data/cit325/oracle/lab5/apply_plsql_lab5_Tang.SQL
@/home/student/Data/cit325/oracle/lab6/apply_lab6_prep.sql

SET SERVEROUTPUT ON SIZE UNLIMITED
SET VERIFY OFF

SPOOL apply_plsql_lab6_Tang.log

-- Part A test a call to the insert_item procedure.
DECLARE
...
-- Part B You need to test a call to the insert_items procedure.
-- for a set of entries after you’ve added the exception handling block.
DECLARE
...
-- Part C test a second call to the insert_items procedure for a set of entries.
DECLARE
...
-- Part D, the last thing you need to check is
-- what has been written to the nc_error table.
